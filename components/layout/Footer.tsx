      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'var(--color-thermal)' }}>
            ...
            <a href="https://www.skywalk.info" target="_blank" rel="noopener noreferrer"
              ...
              <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 shrink-0" style={{ color: 'var(--color-thermal)' }}>
                <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"
                  stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <div>
                <p className="text-xs tracking-widest uppercase" style={{ color: 'var(--color-thermal)' }}>Official Skywalk</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/reserves', label: 'Reserve Parachutes' },
